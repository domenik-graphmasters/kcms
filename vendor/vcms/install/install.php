...
echo "Erstelle Tabelle base_registrations<br />";
$sql = "CREATE TABLE base_registration (
    id int(11) NOT NULL auto_increment,
    name varchar(255),
    datum_geburtstag date,
    email varchar(255),
...
$stmt = $libDb->prepare(
    "INSERT IGNORE INTO base_person (id, vorname, name, gruppe) VALUES (1, :vorname, :name, :gruppe)"
);
...
$stmt = $libDb->prepare(
    "INSERT IGNORE INTO base_person (id, vorname, name, gruppe) VALUES (2, :vorname, :name, :gruppe)"
);
...
$stmt = $libDb->prepare(
    "INSERT IGNORE INTO base_person (id, titel, vorname, name, gruppe, datum_geburtstag, heirat_partner, heirat_datum) VALUES (3, :titel, :vorname, :name, :gruppe, DATE_SUB(CURDATE(), INTERVAL 50 YEAR), 4, DATE_SUB(CURDATE(), INTERVAL 2 DAY))"
);
...
$stmt = $libDb->prepare(
    "INSERT IGNORE INTO base_person (id, vorname, name, gruppe, heirat_partner) VALUES (4, :vorname, :name, :gruppe, 3)"
);
...
$stmt = $libDb->prepare(
    "INSERT IGNORE INTO base_person (id, vorname, name, gruppe) VALUES (5, :vorname, :name, :gruppe)"
);
...
$stmt = $libDb->prepare(
    "INSERT IGNORE INTO base_person (id, vorname, name, gruppe, tod_datum, datum_geburtstag) VALUES (6, :vorname, :name, :gruppe, DATE_SUB(CURDATE(), INTERVAL 3 DAY), DATE_SUB(CURDATE(), INTERVAL 80 YEAR))"
);
...
$stmt = $libDb->prepare(
    "INSERT IGNORE INTO base_veranstaltung (id, datum, titel, beschreibung) VALUES (1, DATE_ADD(CURDATE(), INTERVAL 1 DAY), :titel, :beschreibung)"
);
...
$stmt = $libDb->prepare(
    "INSERT IGNORE INTO base_veranstaltung (id, datum, titel, beschreibung) VALUES (2, DATE_ADD(CURDATE(), INTERVAL 2 DAY), :titel, :beschreibung)"
);
...
$stmt = $libDb->prepare(
    "INSERT IGNORE INTO base_veranstaltung (id, datum, titel, beschreibung) VALUES (3, DATE_ADD(CURDATE(), INTERVAL 10 DAY), :titel, :beschreibung)"
);
...
$stmt = $libDb->prepare(
    "INSERT IGNORE INTO base_veranstaltung (id, datum, titel, beschreibung) VALUES (4, DATE_ADD(CURDATE(), INTERVAL 11 DAY), :titel, :beschreibung)"
);
