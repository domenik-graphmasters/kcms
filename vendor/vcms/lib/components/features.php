...
function hangingFeature(
    ...
    if ($iconId) {
        echo "<i class='fa fa-$iconId me-3 p-4 bg-info rounded' aria-hidden='true' style='display: inline-flex; justify-content: center; align-items: center; width: 3rem; height: 3rem;'></i>";
    }
